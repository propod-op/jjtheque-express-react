...
const GridViewFilms = () => {
  ...
  return (
    <>
      <div className="close-guest" onClick={showGuest}>
        X
      </div>
      <div className="grid-title">LISTE DES FILMS 2023</div>
      <div
        className="guest-zone"
        style={{ display: filmSelectionne ? "flex" : "none" }}
      >
        {filmSelectionne ? (
            ...
            <div className="block-content">
              <div className="content-container">
                <div className="title-container">
                  ...
                  <p>Note : {filmSelectionne.vote_average}</p>
                </div>
                <p className="overview-title">Résumé</p>
                {filmSelectionne?.overview && (
                  <p className="overview-content">
                    {filmSelectionne.overview.slice(0, 600)}{" "}
                    {filmSelectionne.overview.length > 300 && "..."}
                  </p>
                )}
                <p className="actors-title">Acteurs</p>
                {filmSelectionne?.actors && (
                  <p className="actors-content">{filmSelectionne.actors.join(", ")}</p>
                )}
              </div>
            </div>
